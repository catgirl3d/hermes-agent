...
class SessionDB:
    ...
    def get_messages_as_conversation(
        ...
        return self._conversation_from_rows(
            rows,
    ...
    def get_resume_messages(
        ...
        model_history = _strip_background_review_harness(model_history)
        display_history = _strip_background_review_harness(display_history)

        if repair_alternation and model_history:
